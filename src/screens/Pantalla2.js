        ...
        <View style={styles.container}>
            <View style={styles.card}>
                <View style={styles.textContainer}>
                    <Text style={styles.title}>Creadores: {creador.name}</Text>
                    <Text style={styles.title}>Descripción de la practica :</Text>
                </View>
                ...
                <RNPickerSelect
                    ...
                    items={[
                        { label: 'Ver comidas de Ricardo melara', value: 1 },
                        { label: 'Ver comidas de Manuel Enrique', value: 2 },
